...
public class MovieApplication {
	...
	@Bean
	public CommandLineRunner initData(MovieUserRepository movieUserRepository) {
		return (args) -> {
			MovieUser movieUser = movieUserRepository.save(new MovieUser("lucia@cuenca.com", passwordEncoder().encode("123")));
		};
	}
}
